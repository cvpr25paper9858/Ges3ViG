...
class M3DRefCLIP(pl.LightningModule):
    def __init__(self, cfg):
        ...
        #if self.train_pg:
            #return
        if self.dataset_name in ("ScanRefer", "Nr3D", "ImputedScanRefer", "PointRefer", "MultiImputedScanRefer"):
    ...
    def concat_human_feats(self, aabb_feats, batch_proposal_offsets, human_feats):
        #TODO USE CONFIG HERE INSTEAD OF HARD CODING 6
