...
from ges3vig.common_ops.functions import pointgroup_ops, common_ops
from ges3vig.model.module import TinyUnet
from ges3vig.model.module.backbone import Backbone
import lightning.pytorch as pl
import MinkowskiEngine as ME
from ges3vig.loss.pt_offset_loss import PTOffsetLoss
...
class PointGroup(pl.LightningModule):
    ...
    def forward(self, data_dict):
        ...
        #apdhfpiwehgfpierwhgpiehgiprhjfdpoivjwrpifjwerf
        ...
        for b in range(batch_size):
            ...
            #print(f"scene_id: {data_dict['scene_id'][b]}, pred_num:{pred_num}")
        ...
        for b in range(batch_size):
            ...
            #print(f"scene_id: {data_dict['scene_id'][b]}, start_idx: {start_idx}, end_idx:{end_idx}")
